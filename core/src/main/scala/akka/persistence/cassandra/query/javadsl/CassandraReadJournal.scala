...
object CassandraReadJournal {
  ...
  final val Identifier =
    akka.persistence.cassandra.query.scaladsl.CassandraReadJournal.Identifier
}
...
class CassandraReadJournal(
    scaladslReadJournal: akka.persistence.cassandra.query.scaladsl.CassandraReadJournal)
    extends ReadJournal
